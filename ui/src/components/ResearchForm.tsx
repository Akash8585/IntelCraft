...
import { Building2, Factory, Globe, Loader2, Search, MessageSquare } from 'lucide-react';
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="relative group">
            ...
            <p className="text-sm text-gray-600 mb-3 font-['DM_Sans']">
              This short note helps personalize your outreach. Tell us how your product, service, or expertise can help this company. We'll use it to generate more relevant emails and proposals that reflect your unique value.
            </p>
            <div className="relative">
              <div className="absolute inset-0 bg-gradient-to-r from-gray-50/0 via-gray-100/50 to-gray-50/0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-lg"></div>
              <MessageSquare className="absolute left-4 top-4 h-5 w-5 stroke-[#468BFF] transition-all duration-200 group-hover:stroke-[#8FBCFA] z-10" strokeWidth={1.5} />
              <textarea
                id="helpDescription"
                ...
                rows={3}
                className={`${glassStyle.input} transition-all duration-300 focus:border-[#468BFF]/50 focus:ring-1 focus:ring-[#468BFF]/50 group-hover:border-[#468BFF]/30 bg-white/80 backdrop-blur-sm text-lg py-4 pl-12 resize-none font-['DM_Sans']`}
                placeholder="Why are you reaching out to this company?"
              />
            </div>
          </div>
